...
static constexpr auto qt_meta_stringdata_CLASSWorkThreadENDCLASS = QtMocHelpers::stringData(
    "WorkThread",
    "finishOne",
    "",
    "name"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSWorkThreadENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSWorkThreadENDCLASS_t qt_meta_stringdata_CLASSWorkThreadENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "WorkThread"
        QT_MOC_LITERAL(11, 9),  // "finishOne"
        QT_MOC_LITERAL(21, 0),  // ""
...
void WorkThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->finishOne((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &WorkThread::finishOne; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkThread::finishOne(const QString & _t1)
{
